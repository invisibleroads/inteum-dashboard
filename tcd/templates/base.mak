...
<head>
	...
	<link rel='shortcut icon' href='${request.static_url('tcd:static/favicon.ico')}'/>
	<link rel=stylesheet href='${request.static_url('tcd:static/style.css')}'>
...
<script src="${request.static_url('tcd:static/jquery-1.5.2.min.js')}"></script>
${self.root()}
<script>
    $('.hover').live({
